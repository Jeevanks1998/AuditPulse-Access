-- ============================================================================
-- AuditPulse Access Portal — Phase 5 schema (Postgres / Supabase)
...
-- Runs on Postgres via psycopg2 — see backend/database.py's docstring for
-- how sqlite3-style calls (?, lastrowid, executescript) are translated.
-- ============================================================================
